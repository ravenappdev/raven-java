...
public final class EmailOverride implements IChannelOverride {
  ...
  public static final class Builder implements ScheduleAtStage, FromStage, MessageStage, _FinalStage {
    ...
    @Override
    public _FinalStage attachments(Attachment attachments) {
    ...
    @Override
    public _FinalStage bcc(EmailRecipient bcc) {
      this.bcc.add(bcc);
      return this;
    }
    ...
    @Override
    public _FinalStage cc(EmailRecipient cc) {
      this.cc.add(cc);
      return this;
    }
