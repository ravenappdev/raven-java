...
import org.raven.auth.APIKeyAuth;
import org.raven.auth.Authentication;
...
import org.raven.utils.StringUtils;
...
public class APIClient {
    ...
    public <T> T handleResponse(Response response, Type returnType) throws RavenException {
        if (response.isSuccessful()) {
            ...
            throw new RavenException(errorDescription, response.code(), response.headers().toMultimap(), data);
        }
    }
