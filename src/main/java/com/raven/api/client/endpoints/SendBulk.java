package com.raven.api.client.endpoints;
...
public final class SendBulk {
  ...
  public static final class Request {
    ...
    Request(Optional<String> idempotencyKey, String appId, BulkSendEventRequest body,
    ...
    public String toString() {
      return "SendBulk.Request{" + "idempotencyKey: " + idempotencyKey + ", appId: " + appId + ", body: " + body + ", authOverride: " + authOverride + "}";
    }
